...
import com.lokia.repairman.viewpager.CustomViewPager;

import java.util.ArrayList;
import java.util.List;

/**
 * Created by lokia on 16-7-29.
 */
public class RadarActivity  extends Activity implements RadarUploadInfoCallback,
    ...
    private void initUI() {
        ...
        ff3 = BitmapDescriptorFactory.fromResource(R.drawable.icon_marka);
        ...
        mPager.setOnPageChangeListener((ViewPager.OnPageChangeListener) new MyOnPageChangeListener());
    ...
    public void uploadOnceClick(View v) {
        if (pt == null) {
            Toast.makeText(RadarActivity.this, "未获取到位置", Toast.LENGTH_LONG).show();
            return;
        }
    ...
    public void searchNearby(View v) {
        if (pt == null) {
            Toast.makeText(RadarActivity.this, "未获取到位置", Toast.LENGTH_LONG)
                    .show();
            return;
        }
        pageIndex = 0;
    ...
    public boolean onMarkerClick(Marker marker) {
        ...
        mBaiduMap.hideInfoWindow();
        if (marker != null) {
            popupText = new TextView(RadarActivity.this);
    ...
    private class RadarResultListAdapter extends BaseAdapter {
        ...
        public View getView(int index, View convertView, ViewGroup parent) {
            convertView = View.inflate(RadarActivity.this,
